...
cp "${ANDROID_NDK_ROOT}/sources/android/cpufeatures/cpu-features.h" ./include/cryptopp
cp "${ANDROID_NDK_ROOT}/sources/android/cpufeatures/cpu-features.c" ./include/cryptopp
...
sed -e 's/= memmem/= (const char*)memmem/g' \
    ...
    ./include/cryptopp/cpu-features.c > ./include/cryptopp/cpu-features.c.fixed
